...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_unique_paths', type=int, default=20, help="Number of unique paths.")
    parser.add_argument('--max_paths_per_script', type=int, default=5, help="Maximum number of paths per build script.")
    parser.add_argument('--seed', type=int, default=None, help="Random seed for reproducibility.")
    parser.add_argument('--threshold', type=float, default=2.0, help="Threshold for merging build script groups.")
    parser.add_argument('--algorithm', type=str, choices=['greedy'], default='greedy', help="Algorithm to use for merging.")
